...
本文档描述了 MCA Brain System v4.4 发布后的维护与更新策略。
...
在 v4.4.1+ 版本中，我们启用了 **Hotfix Patch System**。
...
**发布方式**: 
1. 运行 `pack.bat`。
2. 将 `dist/MCA_Brain_System_v4.4` 文件夹压缩为 `v4.5-Update.zip` 发布。
